...
public class MessageSearcher {
  ...
  private List<Message> executeRequest(final MessageFilterParams params) {
  ...
  private Long countResult(final MessageFilterParams params) {
    CriteriaBuilder cb = em.getCriteriaBuilder();
  ...
  private List<Predicate> buildPredicates(CriteriaBuilder cb, Root<Message> root, MessageFilterParams params) {
